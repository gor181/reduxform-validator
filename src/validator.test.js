    ...
    describe('validates', () => {
      it('returns undefined when when valid', () => {
        const result = validateMany([
          { predicate: v => v.length > 0, error: 'Cannot be empty!'},
          { predicate: v => v.length < 15, error: 'Less than 15 please!'},
        ], 'a valid string');
